...
import { idlFactory } from './CarbonFootprintAssistant.did.js';
export { idlFactory } from './CarbonFootprintAssistant.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CARBONFOOTPRINTASSISTANT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./CarbonFootprintAssistant.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the CarbonFootprintAssistant canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./CarbonFootprintAssistant.did.js")._SERVICE>}
 */
export const CarbonFootprintAssistant = createActor(canisterId);
